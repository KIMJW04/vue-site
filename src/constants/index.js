...
export const skillText = [
  {
    title: "꿈을 설계하고 디자인하다.",
    desc: "꿈을 설계하고 디자인하는 과정은 저의 열정과 창의력을 최대한으로 발휘하는 시간입니다. 새로운 아이디어를 떠올리고, 그것을 현실로 만들기 위해 끊임없이 도전합니다. 이러한 과정에서 얻는 경험과 지식은 저를 한층 더 성장하게 만들며, 제가 원하는 특별한 목표를 이루는 데 큰 도움이 됩니다.",
  },
  {
    title: "문제를 해결하고 극복하다.",
    desc: "도전하는 과정에서는 항상 예상치 못한 문제들이 발생합니다. 이러한 문제들을 해결하기 위해 여러 가지 방법을 시도하며, 실패를 두려워하지 않습니다. 문제 해결 능력을 키우고, 끈기와 인내심을 통해 어려움을 극복해 나갑니다. 이 과정에서 배운 것들은 저를 더 강하게 만들고, 다음 도전에 대한 자신감을 줍니다.",
  },
  {
    title: "포용력으로 함께 성장하다.",
    desc: "포용력은 다양한 사람들의 생각과 문화를 이해하고 존중하는 능력입니다. 다른 사람들의 의견을 존중하고 수용함으로써 더 나은 결정을 내릴 수 있게 됩니다. 포용력을 통해 팀의 결속력을 높이고, 모두가 함께 성장하는 긍정적인 변화를 이끌어냅니다. 이를 통해 저와 제 주변 사람들 모두가 더 나은 방향으로 발전할 수 있습니다.",
  },
];
...
export const siteText = [
  ...
  },
  {
    ...
    code: "https://github.com/KIMJW04/youtube_music",
  ...
  },
  {
    ...
    title: "뷰를 이용한 사이트 제작",
    code: "https://github.com/KIMJW04/vue-site",
...
export const contactText = [
  {
    ...
    title: "KAKAO : kjw040416",
  },
  {
    link: "mailto:kjw040416@gmail.com",
    title: "mail : kjw040416@gmail.com",
  },
];
